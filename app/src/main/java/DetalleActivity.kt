...
class DetalleActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Log.d(TAG, "Detalle cargado → ${vehiculo.placa}")
    }
    ...
    private fun poblarUI(vehiculo: VehiculoInfractor) {
        ...
        aplicarColorBadgeGravedad(vehiculo.gravedad)
    }

    private fun aplicarColorBadgeGravedad(gravedad: String) {
        ...
        tvGravedad.setBackgroundColor(ContextCompat.getColor(this, colorRes))
    }
